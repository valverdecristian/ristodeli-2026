...
export class ManagementActionsComponent implements OnInit {
  ...
  private allActions = [
    ...
    // Acciones de Cocina 
    { title: 'Agregar Plato', icon: 'fast-food-outline', color: '#f5a623', action: 'add_plato', roles: ['cocinero'] },
    { title: 'Agregar Postre', icon: 'ice-cream-outline', color: '#f5a623', action: 'add_postre', roles: ['cocinero'] },
    { title: 'Menú de Platos y Postres', icon: 'restaurant-outline', color: '#f5a623', action: 'view_menu_platos', roles: ['cocinero'] },
    { title: 'Pedidos Pendientes', icon: 'clipboard-outline', color: '#f5a623', action: 'view_orders', roles: ['cocinero'] },
    
    // Acciones de Bar 
    { title: 'Agregar Bebida', icon: 'wine-outline', color: '#f5a623', action: 'add_bebida', roles: ['bartender', 'cantinero'] },
    { title: 'Menú Bebidas', icon: 'book-outline', color: '#f5a623', action: 'view_menu_bebidas', roles: ['bartender', 'cantinero'] },
    { title: 'Comandas Bar', icon: 'clipboard-outline', color: '#f5a623', action: 'view_orders_bar', roles: ['bartender', 'cantinero'] },
    
    // Acciones de Metre 
    { title: 'Lista de Espera', icon: 'list-outline', color: '#f5a623', action: 'view_waiting_list', roles: ['metre'] },
    { title: 'Ver Mesas', icon: 'grid-outline', color: '#f5a623', action: 'view_tables', roles: ['admin', 'supervisor', 'metre'] },
  ...
  hideLogo = false;
  updateLogo(){
    this.hideLogo = this.visibleActions.length > 4;
  }
