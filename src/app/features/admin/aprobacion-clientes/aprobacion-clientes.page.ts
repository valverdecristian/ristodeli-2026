...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonButtons, IonBackButton, IonList, IonItem, IonAvatar, IonLabel, IonButton, IonIcon, IonGrid, IonRow, IonCol, IonSkeletonText } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonHeader, IonTitle, IonToolbar, IonButtons, IonBackButton, CommonModule, FormsModule, IonList, IonItem, IonAvatar, IonLabel, IonButton, IonIcon, IonGrid, IonRow, IonCol, IonSkeletonText]
})
