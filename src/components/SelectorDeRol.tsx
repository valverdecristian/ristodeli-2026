              ...
              {roles.map((r) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    className={`w-full flex-row items-center p-4 rounded-3xl mb-3 shadow-md border-b-4 border-gray-300 active:opacity-80 ${isSelected ? 'bg-tertiary' : 'bg-secondary'
                      }`}
                  >
                    {/* Circulo con Emoji */}
                    ...
                    {/* Tilde indicador si esta seleccionado */}
                    {isSelected && (
