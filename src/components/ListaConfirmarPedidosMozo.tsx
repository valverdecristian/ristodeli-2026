...
export default function ListaConfirmarPedidosMozo() {
    ...
    // 🌟 ESTADOS NUEVOS PARA EL MODAL DEL MOZO
    ...
    // 🌟 1. ABRE EL MODAL AL TOCAR "RECHAZAR"
    ...
    // 🌟 2. PROCESA EL RECHAZO FINAL CON EL MOTIVO ESCRITO
    const confirmarRechazo = async () => {
        ...
        try {
            ...
            // Insertamos la palabra Rechazado + el motivo para que el cliente lo corte
            ...
            setModalRechazoVisible(false); // Cerramos el modal
            fetchPedidosAConfirmar(); // Recargamos la lista
            
            // 🚫 Chau router.push al chat. El mozo se queda acá.
    ...
    return (
        <>
            ...
            {/* 🌟 3. EL MODAL QUE CAPTURA EL MOTIVO */}
