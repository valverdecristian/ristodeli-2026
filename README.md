...
<p align="center">
  <img src="assets/images//icon.png" alt="Logo de la App" width="250">
</p>
...
| :---------------------------------------------------------- | :--------------------------- | :----------- | :----------------------------- |
| 1. Agregar un empleado                                      | dueño o supervisor           | ✅ Corregido | 16/05/2026 - Octavio, Villegas |
| 2. Agregar un nuevo plato                                   | cocinero                     | ✅ Corregido | 16/05/2026 - Octavio, Villegas |
| 3. Agregar una nueva bebida                                 | cantinero                    | ✅ Corregido | 16/05/2026 - Octavio, Villegas |
| 4. Agregar una nueva mesa                                   | dueño o supervisor           | ✅ Corregido | 30/05/2026 - Alejandro Loredo  |
| 5. Crear un cliente registrado                              | cliente o metre              | ✅ Corregido | 16/05/2026 - Octavio, Villegas |
| 6. Verificar ingreso del cliente registrado                 | dueño o supervisor           | ✅ Corregido | 30/05/2026 - Alejandro Loredo  |
| 7. Rechazar a un cliente registrado                         | dueño o supervisor           | ✅ Corregido | 30/05/2026 - Alejandro Loredo  |
| 8. Aceptar a un cliente registrado                          | dueño o supervisor           | ✅ Corregido | 30/05/2026 - Alejandro Loredo  |
| 9. Ingresar al local                                        | cliente anónimo              | ✅ Corregido | 30/05/2026 - Alejandro Loredo  |
| 10. Asignar una mesa a un cliente registrado                | metre                        | ✅ Corregido | 30/05/2026 - Alejandro Loredo  |
| 11. Ver el listado de los productos                         | cliente registrado o anónimo | ✅ Corregido | 30/05/2026 - Alejandro Loredo  |
| 12. Realizar el pedido para todos los comensales de la mesa | cliente registrado o anónimo | ✅ Corregido | 30/05/2026 - Alejandro Loredo  |
| 13. Rechazar el pedido, para que el usuario lo modifique    | mozo                         | ✅ Corregido | 30/05/2026 - Alejandro Loredo  |
| 14. Confirmar el pedido                                     | mozo                         | ✅ Corregido | 30/05/2026 - Alejandro Loredo  |
| 15. Acceder a los juegos                                    | cliente registrado o anónimo | ✅ Corregido | 30/05/2026 - Alejandro Loredo  |
| 16. Recepción de los productos correspondientes             | cocinero                     | ✅ Corregido | 30/05/2026 - Alejandro Loredo  |
| 17. Recepción de los productos correspondientes             | cantinero                    | ✅ Corregido | 30/05/2026 - Alejandro Loredo  |
| 18. Realizar las tareas correspondientes                    | cocinero y cantinero         | ✅ Corregido | 30/05/2026 - Alejandro Loredo  |
| 19. Entrega del pedido completo                             | mozo                         | ✅ Corregido | 30/05/2026 - Alejandro Loredo  |
| 20. Acceder a la encuesta de satisfacción                   | cliente registrado o anónimo | ✅ Corregido | 30/05/2026 - Alejandro Loredo  |
| 21. Solicitar cuenta al mozo                                | cliente registrado o anónimo | ✅ Corregido | 30/05/2026 - Alejandro Loredo  |
| 22. Confirmar el pago y liberar mesa                        | mozo                         | ✅ Corregido | 30/05/2026 - Alejandro Loredo  |
...
A continuación se detalla el proceso que debe seguir un cliente para ingresar y utilizar la aplicación:

### 1️⃣ Descargar la Aplicación

El cliente debe descargar la app RISTODELI desde la plataforma correspondiente (Google Play o App Store).
...
- Completa el formulario de registro con sus datos personales
- Escanea su DNI para cargar automáticamente la información
- Captura una foto obligatoria
- **Debe esperar aprobación** del admin o supervisor para poder ingresar
- Una vez aprobado, podrá acceder a todas las funcionalidades

#### 🔓 Cliente Anónimo

- Selecciona la opción "Ingresar como Cliente Anónimo"
- **Acceso inmediato** sin necesidad de aprobación
- Tiene acceso limitado a algunas funcionalidades

### 3️⃣ Escanear QR de Entrada

Una vez autenticado (aprobado o anónimo), el cliente debe:

- Dirigirse a la **entrada del local**
- **Escanear el QR de entrada** (ver sección Códigos QR más abajo)
- Esto registra su ingreso en el sistema

### 4️⃣ Esperar Asignación de Mesa

- El cliente espera a que el **Metre le asigne una mesa**
- Se realiza mediante los botones de asignación disponibles en la sección de mesas

### 5️⃣ Recibir Notificación

- El cliente recibe una **notificación push** informando que su mesa ha sido asignada
- La notificación incluye el número de mesa

### 6️⃣ Escanear QR de la Mesa

- El cliente se dirige a la **mesa asignada**
- **Escanea el QR de la mesa** (ver sección Códigos QR más abajo)
- Una vez validado, obtiene acceso a:
  - 📋 Menú de productos
  - 🎮 Juegos interactivos
  - 📊 Encuesta de satisfacción
  - 💬 Consultas al mozo

### 7️⃣ Disfrutar de la Experiencia

- Realiza sus pedidos
- Juega mientras espera
- Completa la encuesta de satisfacción
- Solicita la cuenta cuando termine
...
- **`feature/dev-alfa` / `feature/dev-beta` / `feature/dev-gamma`**: Ramas de desarrollo individual.
